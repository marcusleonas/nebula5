...
export const navLinks: NavGroup[] = [
    ...
    links: [
      {
        href: "/about",
        label: "about me",
        description: "learn a little more about me - webrings are here too!",
        icon: Info,
      },
      {
        href: "/gaming",
  ...
  },
  {
    ...
    links: [
      ...
      {
        href: "https://coneheads.n3bula.lol",
        description: "my webring for conan gray fans!",
        label: "coneheads webring",
        icon: Link,
        external: true,
      },
    ],
